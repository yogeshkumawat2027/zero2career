...
export default function GovtUpdatesPage() {
  ...
  const getCategoryColor = (category) => {
    switch (category) {
      ...
      case 'admit card': return 'bg-blue-100 text-blue-800 border-blue-300';
      case 'result': return 'bg-purple-100 text-purple-800 border-purple-300';
              ...
              filteredUpdates.map((update) => (
                ...
                >
                  <div className="p-4 md:p-6 flex flex-col flex-grow">
                    ...
                    {/* Title - Clickable */}
                    <h3 
                      onClick={() => update.slug && router.push(`/govt-updates/${update.slug}`)}
                    ...
                    <div className="mt-auto">
                      ...
                      {update.slug ? (
                        <button
                          onClick={() => router.push(`/govt-updates/${update.slug}`)}
